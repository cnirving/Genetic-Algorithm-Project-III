...
public class Main {
	...
	public static double v0 = 85;
	public static double rho = 1; //pendulum rod length
	public static String[] tspCities = Algorithms.generateTspCities();
	public static String actionMutate = "a lot";
	public static int i;
	...
	public static void main(String[] args) {
		...
		// Printing/useless variables (not to be included in final code)
		System.out.println("Initial Population: " + population.toString());
		Individual initialFittest = population.getFittest();
		double initFit = initialFittest.getFitness();
		...
		drawDiagram = new DrawDiagram(population, frameDiagramSize);
		frameDiagram.add(drawDiagram);
		frameDiagram.setVisible(true);
		...
		for (i = 1; i <= NUM_GENS; i++) {
			...
			//System.out.println("Generation {" + i + "} fittest: " + population.getFittest().toString());
			//System.out.println("Generation {" + i + "} fittest distance: " + 10000/population.getFittest().getFitness());
